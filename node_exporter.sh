...
cd /opt/node_exporter-1.6.1.linux-amd64
sudo cp /opt/node_exporter-1.6.1.linux-amd64/node_exporter /usr/local/bin

sudo cat <<EOL | sudo tee /lib/systemd/system/node_exporter.service
[Unit]
